...
if (file_exists('/var/zpanel/hostdata/jeremysloan/www_config/dccommunitysplashpad-settings.inc')) {
  require('/var/zpanel/hostdata/jeremysloan/www_config/dccommunitysplashpad-settings.inc');
}

if (file_exists('/mnt/webdev/configs/dcsplashpad/dcsplashpad.com.inc')) {
  require('/mnt/webdev/configs/dcsplashpad/dcsplashpad.com.inc');
}
